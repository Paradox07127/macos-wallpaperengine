...
/// Not `MTLBlitCommandEncoder.copy`: blit reinterprets BC block bytes as RGBA pixels (green-tinted noise) instead of decompressing — decompression must go through a sampling shader.
