...
struct AIEngineWidgetView: View {
...
#Preview("ANE Memory · S") {
    HStack(spacing: 20) {
        AIEngineWidgetView(context: aiEnginePreviewContext(size: .small))
            .frame(width: 170, height: 170)
        AIEngineWidgetView(context: aiEnginePreviewContext(
...
#Preview("ANE Memory · M") {
    VStack(spacing: 20) {
        AIEngineWidgetView(context: aiEnginePreviewContext(size: .medium))
...
#Preview("ANE Memory · L") {
    HStack(alignment: .top, spacing: 20) {
        AIEngineWidgetView(context: aiEnginePreviewContext(size: .large))
