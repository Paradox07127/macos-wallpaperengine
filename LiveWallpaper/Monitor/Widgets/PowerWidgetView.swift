...
#Preview("Power · S") {
    HStack(spacing: 24) {
        PowerWidgetView(context: powerContext(laptopSystem(), size: .small))
            .frame(width: 170, height: 170)
        PowerWidgetView(context: powerContext(lowBatterySystem(), size: .small))
            .frame(width: 170, height: 170)
        PowerWidgetView(context: powerContext(desktopSystem(), size: .small))
            .frame(width: 170, height: 170)
    }
    .padding(32)
...
#Preview("Power · M") {
    VStack(spacing: 24) {
        PowerWidgetView(context: powerContext(laptopSystem(), size: .medium))
            .frame(width: 364, height: 170)
        PowerWidgetView(context: powerContext(lowBatterySystem(), size: .medium))
            .frame(width: 364, height: 170)
        PowerWidgetView(context: powerContext(desktopSystem(), size: .medium))
            .frame(width: 364, height: 170)
    }
    .padding(32)
    .background(Design.boardWash)
