...
struct NixieClockView: View {
    ...
    private nonisolated static let designHeight: CGFloat = 460
    private nonisolated static let pairGap: CGFloat = 28
    private nonisolated static let designWidth = tubeWidth * 6 + pairGap * 2
