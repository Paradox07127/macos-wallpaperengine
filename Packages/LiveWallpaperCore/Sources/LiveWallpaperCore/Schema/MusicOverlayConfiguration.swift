...
/// How large the Now Playing layer draws; the three steps match the Monitor widget sizes.
...
/// Deliberately not a Monitor widget: one per display, its own switch and window, never on
/// the board's grid.
