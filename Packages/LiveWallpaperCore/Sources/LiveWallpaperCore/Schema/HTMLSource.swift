...
public enum HTMLSource: Codable, Equatable, Sendable {
    ...
    public var displayName: String {
        ...
        case .file(let bookmark):
            return ResourceUtilities.resolveBookmarkName(bookmark) ?? String(localized: "Local file", bundle: .appLanguage, comment: "HTML source display name fallback when the bookmark name cannot be resolved.")
        case .folder(let bookmark, let index):
            let folderName = ResourceUtilities.resolveBookmarkName(bookmark) ?? String(localized: "Folder", bundle: .appLanguage, comment: "HTML source display name fallback when the bookmark name cannot be resolved.")
