    ...
    public var errorDescription: String? {
        ...
        case .fileAccessDenied(let name):
            return String(
                ...
                bundle: .appLanguage, comment: "Error shown when the app cannot access a selected wallpaper file."
            )
        case .wpePackageInvalid(let detail):
            return String(
                ...
                bundle: .appLanguage, comment: "Error shown when a Wallpaper Engine package is invalid."
            )
        case .wpeImportFailed(let detail):
            return String(
                localized: "error.app.wpe_import_failed",
                defaultValue: "Wallpaper Engine import failed: \(detail)",
                bundle: .appLanguage, comment: "Error shown when importing a Wallpaper Engine package fails."
            )
        }
    }
    ...
    public var recoverySuggestion: String? {
        ...
        case .fileAccessDenied:
            return String(
                ...
                bundle: .appLanguage, comment: "Recovery suggestion for file access errors."
            )
        case .wpePackageInvalid:
            return String(
                ...
                bundle: .appLanguage, comment: "Recovery suggestion for invalid Wallpaper Engine packages."
            )
        case .wpeImportFailed:
            return String(
                ...
                bundle: .appLanguage, comment: "Recovery suggestion for Wallpaper Engine import failures."
            )
        }
    }
}
