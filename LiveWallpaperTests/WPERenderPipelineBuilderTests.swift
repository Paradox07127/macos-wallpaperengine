...
struct WPERenderPipelineBuilderTests {
    ...
    func officialTextureFormatABIValues() {
        ...
        #expect(WPEOfficialTextureFormatABI.shaderValue(for: .dxt5) == 4)
        #expect(WPEOfficialTextureFormatABI.shaderValue(for: .rg88) == 8)
        #expect(WPEOfficialTextureFormatABI.shaderValue(for: .rgba1010102) == nil)
