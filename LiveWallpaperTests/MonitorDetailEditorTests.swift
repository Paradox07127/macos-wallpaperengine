...
struct MonitorDetailEditorTests {
    ...
    func refreshRateLabelClamps() {
        #expect(MonitorBoardSettingsView.refreshHzLabel(1.0) == "1.0 Hz")
        #expect(MonitorBoardSettingsView.refreshHzLabel(5.0) == "2.0 Hz")
        #expect(MonitorBoardSettingsView.refreshHzLabel(0.05) == "0.2 Hz")
    }
