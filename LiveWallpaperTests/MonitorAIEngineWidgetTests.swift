...
struct MonitorAIEngineWidgetTests {
    ...
    func displayState() {
        #expect(MonitorAIEngineWidgetView.displayState(footprintPresent: nil) == .unsampled)
        #expect(MonitorAIEngineWidgetView.displayState(footprintPresent: false) == .empty)
        #expect(MonitorAIEngineWidgetView.displayState(footprintPresent: true) == .present)
    }
