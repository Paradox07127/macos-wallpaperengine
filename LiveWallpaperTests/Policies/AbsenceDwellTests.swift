...
struct AbsenceDwellTests {
    ...
    /// Holds the first attempt right before it would clear the slot; without the gate
    /// the attempt clears it before a test can replace it and the race never happens.
    @MainActor
