...
struct WPEOfficialDocsCorpusAuditTests {
    ...
    private static let sceneScriptEventContracts: [[String: String]] = [
        ...
        ["name": "applyGeneralSettings", "status": "implemented", "evidence": "L0.5", "producer": "AppLanguagePreference plus renderer actor FIFO", "limitation": "The app exposes five localized UI languages; unsupported system localizations follow the app's English development fallback."],
