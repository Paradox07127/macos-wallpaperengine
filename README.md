...
- **Desktop overlays** — 12 particle effects, live weather response, and a configurable board with eleven widget types, including a combined System Overview, Weather and local AI-agent sessions. Arrange and resize widgets per display.
