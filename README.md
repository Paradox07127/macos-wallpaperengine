...
- **Desktop overlays** — 12 particle effects, live weather response, and a configurable board with twelve widget types, including System Overview, a transparent Nixie Clock, Weather and local AI-agent sessions. Arrange and resize widgets per display.
